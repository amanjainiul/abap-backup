class ZCL_Z_EWM_INVENTORY_02_DPC definition
  public
...
protected section.
  ...
  methods INVENTORYADJUSTM_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_EWM_INVENTORY_02_MPC=>TS_INVENTORYADJUSTMENTITEM
    raising
  ...
  methods INVENTORYADJUSTM_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_EWM_INVENTORY_02_MPC=>TT_INVENTORYADJUSTMENTITEM
...
CLASS ZCL_Z_EWM_INVENTORY_02_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 18.09.2025 11:36:05 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EWM_INVENTORY_02_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA inventoryadjustm_create_entity TYPE zcl_z_ewm_inventory_02_mpc=>ts_inventoryadjustmentitem.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA inventoryadjustm_get_entity TYPE zcl_z_ewm_inventory_02_mpc=>ts_inventoryadjustmentitem.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EWM_INVENTORY_02_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA inventoryadjustm_get_entityset TYPE zcl_z_ewm_inventory_02_mpc=>tt_inventoryadjustmentitem.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA inventoryadjustm_update_entity TYPE zcl_z_ewm_inventory_02_mpc=>ts_inventoryadjustmentitem.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
