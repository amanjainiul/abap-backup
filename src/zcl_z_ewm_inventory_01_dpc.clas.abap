class ZCL_Z_EWM_INVENTORY_01_DPC definition
  public
...
protected section.
  ...
  methods INVENTORYADJUS01_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_EWM_INVENTORY_01_MPC=>TS_INVENTORYADJUSTMENTITEM
    raising
  ...
  methods INVENTORYADJUS01_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_EWM_INVENTORY_01_MPC=>TT_INVENTORYADJUSTMENTITEM
  ...
  methods INVENTORYADJUSTM_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z_EWM_INVENTORY_01_MPC=>TS_INVENTORYADJUSTMENT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods INVENTORYADJUSTM_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z_EWM_INVENTORY_01_MPC=>TT_INVENTORYADJUSTMENT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_Z_EWM_INVENTORY_01_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 04.09.2025 19:42:38 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EWM_INVENTORY_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA inventoryadjustm_create_entity TYPE zcl_z_ewm_inventory_01_mpc=>ts_inventoryadjustment.
 DATA inventoryadjus01_create_entity TYPE zcl_z_ewm_inventory_01_mpc=>ts_inventoryadjustmentitem.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA inventoryadjustm_get_entity TYPE zcl_z_ewm_inventory_01_mpc=>ts_inventoryadjustment.
 DATA inventoryadjus01_get_entity TYPE zcl_z_ewm_inventory_01_mpc=>ts_inventoryadjustmentitem.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EWM_INVENTORY_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA inventoryadjustm_get_entityset TYPE zcl_z_ewm_inventory_01_mpc=>tt_inventoryadjustment.
 DATA inventoryadjus01_get_entityset TYPE zcl_z_ewm_inventory_01_mpc=>tt_inventoryadjustmentitem.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA inventoryadjustm_update_entity TYPE zcl_z_ewm_inventory_01_mpc=>ts_inventoryadjustment.
 DATA inventoryadjus01_update_entity TYPE zcl_z_ewm_inventory_01_mpc=>ts_inventoryadjustmentitem.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
