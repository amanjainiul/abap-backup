class ZCL_Z_EWM_INVENTORY_09_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_INVENTORYADJUSTMENTITEMN,
  ...
  end of TS_INVENTORYADJUSTMENTITEMN .
  types:
TT_INVENTORYADJUSTMENTITEMN type standard table of TS_INVENTORYADJUSTMENTITEMN .
  types:
  ...
  constants GC_INVENTORYADJUSTMENTITEMN type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'InventoryAdjustmentItemN' ##NO_TEXT.
...
CLASS ZCL_Z_EWM_INVENTORY_09_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_EWM_INVENTORY_ADJ_NEW1_SRV' ).
...
***********************************************************************************************************************************
*   ENTITY - InventoryAdjustmentItemN
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'InventoryAdjustmentItemN' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_EWM_INVENTORY_09_MPC=>TS_INVENTORYADJUSTMENTITEMN' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'InventoryAdjustmentItemNSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250918112006'.                  "#EC NOTEXT
