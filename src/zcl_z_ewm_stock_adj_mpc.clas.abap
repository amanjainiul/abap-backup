class ZCL_Z_EWM_STOCK_ADJ_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_STOCKADJUSTMENTITEM,
  ...
  end of TS_STOCKADJUSTMENTITEM .
  types:
TT_STOCKADJUSTMENTITEM type standard table of TS_STOCKADJUSTMENTITEM .
  types:
  ...
  constants GC_STOCKADJUSTMENTITEM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'StockAdjustmentItem' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_STOCKADJUSTMENTITEM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_EWM_STOCK_ADJ_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_EWM_STOCK_ADJ_SRV' ).

define_stockadjustmentitem( ).
  endmethod.


  method DEFINE_STOCKADJUSTMENTITEM.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - StockAdjustmentItem
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'StockAdjustmentItem' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_EWM_STOCK_ADJ_MPC=>TS_STOCKADJUSTMENTITEM' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'StockAdjustmentItemSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250918160252'.                  "#EC NOTEXT
