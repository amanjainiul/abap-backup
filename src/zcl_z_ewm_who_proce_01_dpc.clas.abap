class ZCL_Z_EWM_WHO_PROCE_01_DPC definition
  public
...
protected section.
  ...
  methods WAREHOUSEORDERSE_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_EWM_WHO_PROCE_01_MPC=>TS_WAREHOUSEORDER
    raising
  ...
  methods WAREHOUSEORDERSE_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_EWM_WHO_PROCE_01_MPC=>TT_WAREHOUSEORDER
  ...
  methods WAREHOUSETASKSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z_EWM_WHO_PROCE_01_MPC=>TS_WAREHOUSETASK
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods WAREHOUSETASKSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z_EWM_WHO_PROCE_01_MPC=>TT_WAREHOUSETASK
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_Z_EWM_WHO_PROCE_01_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 02.10.2025 19:49:12 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EWM_WHO_PROCE_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA warehouseorderse_create_entity TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehouseorder.
 DATA warehousetaskset_create_entity TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehousetask.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA warehouseorderse_get_entity TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehouseorder.
 DATA warehousetaskset_get_entity TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehousetask.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EWM_WHO_PROCE_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA warehouseorderse_get_entityset TYPE zcl_z_ewm_who_proce_01_mpc=>tt_warehouseorder.
 DATA warehousetaskset_get_entityset TYPE zcl_z_ewm_who_proce_01_mpc=>tt_warehousetask.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA warehouseorderse_update_entity TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehouseorder.
 DATA warehousetaskset_update_entity TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehousetask.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
METHOD warehouseorderse_get_entity.
  ...
  DATA: lt_whoid     TYPE /scwm/tt_whoid,
        ...
        ls_who       TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehouseorder,
...
METHOD warehousetaskset_get_entity.
  ...
  DATA: ls_task_o TYPE /scwm/ordim_o,
        ...
        ls_entity TYPE zcl_z_ewm_who_proce_01_mpc=>ts_warehousetask,
        lv_lgnum  TYPE /scwm/lgnum,
