class ZCL_Z_ODATA_WO_FRAMEWO_MPC definition
  public
...
public section.
  ...
  begin of TS_WAREHOUSEORDER,
     ...
     SRC_LGTYP type C length 3,
     DEST_LGTYP type C length 3,
     RSRCTY type C length 4,
...
TT_WAREHOUSEORDER type standard table of TS_WAREHOUSEORDER .
  ...
  begin of TS_WAREHOUSETASK,
     ...
     QTY type P length 2 decimals 0,
     STATUS type C length 1,
...
CLASS ZCL_Z_ODATA_WO_FRAMEWO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_ODATA_WO_FRAMEWORK_SRV' ).
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'WO_To_WT_AssociationSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'WarehouseOrders'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'WarehouseTasks'             "#EC NOTEXT
                                              iv_association_name      = 'WO_To_WT_Association' ).                                 "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SRC_LGTYP' iv_abap_fieldname = 'SRC_LGTYP' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 3 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DEST_LGTYP' iv_abap_fieldname = 'DEST_LGTYP' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 3 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'RSRCTY' iv_abap_fieldname = 'RSRCTY' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_ODATA_WO_FRAMEWO_MPC=>TS_WAREHOUSEORDER' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'WarehouseOrders' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_ODATA_WO_FRAMEWO_MPC=>TS_WAREHOUSETASK' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'WarehouseTasks' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250825090128'.                  "#EC NOTEXT
