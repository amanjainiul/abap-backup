class ZCL_Z_EWM_INVENTORY_04_MPC definition
  public
...
CLASS ZCL_Z_EWM_INVENTORY_04_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_EWM_INVENTORY_ADJ_SRV_03' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_EWM_INVENTORY_04_MPC=>TS_INVENTORYADJUSTMENTITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250918094738'.                  "#EC NOTEXT
