class ZCL_Z_EWM_INVENTORY_08_MPC definition
  public
...
public section.
  ...
  begin of TS_INVENTORYADJUSTMENTITEM,
     ...
     COUNT_QTY type P length 8 decimals 3,
...
CLASS ZCL_Z_EWM_INVENTORY_08_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_EWM_INVENTORY_ADJ_SRV_06' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'COUNT_QTY' iv_abap_fieldname = 'COUNT_QTY' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_EWM_INVENTORY_08_MPC=>TS_INVENTORYADJUSTMENTITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250918111223'.                  "#EC NOTEXT
