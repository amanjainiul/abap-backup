class ZCL_Z_EWM_INVENTORY_07_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_INVENTORYADJUSTMENTITEM1,
     ...
     CNTQTY type P length 8 decimals 3,
  ...
  end of TS_INVENTORYADJUSTMENTITEM1 .
  types:
TT_INVENTORYADJUSTMENTITEM1 type standard table of TS_INVENTORYADJUSTMENTITEM1 .
  types:
  ...
  constants GC_INVENTORYADJUSTMENTITEM1 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'InventoryAdjustmentItem1' ##NO_TEXT.
...
CLASS ZCL_Z_EWM_INVENTORY_07_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_EWM_INVENTORY_ADJ_NEW_SRV' ).
...
***********************************************************************************************************************************
*   ENTITY - InventoryAdjustmentItem1
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'InventoryAdjustmentItem1' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_EWM_INVENTORY_07_MPC=>TS_INVENTORYADJUSTMENTITEM1' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'InventoryAdjustmentItem1Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250918105122'.                  "#EC NOTEXT
